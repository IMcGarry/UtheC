...
public class Webpage extends JFrame {
    ...
    public Webpage(){
        ...
        width = dim.getWidth() - 10;
        height = dim.getHeight() - 50;
        ...
        briefHisTime.addMouseListener(Main.bl);
        ...
        briefAnsBigQs.addMouseListener(Main.bl);
        ...
        theoryOfAll.addMouseListener(Main.bl);
        ...
        uniInNutshell.addMouseListener(Main.bl);
        ...
        hobbit.addMouseListener(Main.bl);
        ...
        silmarillion.addMouseListener(Main.bl);
        ...
        fellowship.addMouseListener(Main.bl);
        ...
        twoTowers.addMouseListener(Main.bl);
        ...
        returnOfKing.addMouseListener(Main.bl);
        ...
        fantasticBeasts.addMouseListener(Main.bl);
        ...
        davinci.addMouseListener(Main.bl);
        ...
        angelsAndDemons.addMouseListener(Main.bl);
        ...
        inferno.addMouseListener(Main.bl);
        ...
        origin.addMouseListener(Main.bl);
        ...
        deceptPoint.addMouseListener(Main.bl);
        ...
        digFortress.addMouseListener(Main.bl);
        ...
        lostSym.addMouseListener(Main.bl);
        ...
        neuromancer.addMouseListener(Main.bl);
        ...
        burningChrome.addMouseListener(Main.bl);
        ...
        miraWork.addMouseListener(Main.bl);
        ...
        sparPart.addMouseListener(Main.bl);
        ...
        time4Mercy.addMouseListener(Main.bl);
        ...
        litigators.addMouseListener(Main.bl);
        ...
        reckoning.addMouseListener(Main.bl);
        ...
        whistler.addMouseListener(Main.bl);
        ...
        confession.addMouseListener(Main.bl);
        ...
        caminoGhosts.addMouseListener(Main.bl);
        ...
        caminoWinds.addMouseListener(Main.bl);
        ...
        caminoIsland.addMouseListener(Main.bl);
        ...
        steppenwolf.addMouseListener(Main.bl);
        ...
        siddhartha.addMouseListener(Main.bl);
        ...
        rosshalde.addMouseListener(Main.bl);
        ...
        demian.addMouseListener(Main.bl);
        ...
        glassBead.addMouseListener(Main.bl);
        ...
        kafkaShore.addMouseListener(Main.bl);
        ...
        norWood.addMouseListener(Main.bl);
        ...
        firstPersonSing.addMouseListener(Main.bl);
